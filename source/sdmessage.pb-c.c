...
void   entry_m__init
                     (EntryM         *message)
{
  static const EntryM init_value = ENTRY_M__INIT;
  *message = init_value;
}
size_t entry_m__get_packed_size
                     (const EntryM *message)
{
  assert(message->base.descriptor == &entry_m__descriptor);
...
{
  return (EntryM *)
     protobuf_c_message_unpack (&entry_m__descriptor,
                                allocator, len, data);
}
...
void   data_m__init
                     (DataM         *message)
{
  static const DataM init_value = DATA_M__INIT;
  *message = init_value;
}
size_t data_m__get_packed_size
                     (const DataM *message)
{
  assert(message->base.descriptor == &data_m__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
size_t data_m__pack
                     (const DataM *message,
...
{
  return (DataM *)
     protobuf_c_message_unpack (&data_m__descriptor,
                                allocator, len, data);
}
...
static const ProtobufCFieldDescriptor entry_m__field_descriptors[2] =
{
  {
    "key",
    1,
...
static const unsigned entry_m__field_indices_by_name[] = {
  1,   /* field[1] = data */
  0,   /* field[0] = key */
};
static const ProtobufCIntRange entry_m__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 2 }
};
const ProtobufCMessageDescriptor entry_m__descriptor =
{
  ...
  sizeof(EntryM),
  2,
  entry_m__field_descriptors,
  entry_m__field_indices_by_name,
  1,  entry_m__number_ranges,
  (ProtobufCMessageInit) entry_m__init,
  NULL,NULL,NULL    /* reserved[123] */
};
static const ProtobufCFieldDescriptor data_m__field_descriptors[2] =
{
  {
    "datasize",
    1,
...
static const unsigned data_m__field_indices_by_name[] = {
  1,   /* field[1] = data */
  0,   /* field[0] = datasize */
};
static const ProtobufCIntRange data_m__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 2 }
};
const ProtobufCMessageDescriptor data_m__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  "data_m",
  "DataM",
  ...
  sizeof(DataM),
  2,
  data_m__field_descriptors,
  data_m__field_indices_by_name,
  1,  data_m__number_ranges,
  (ProtobufCMessageInit) data_m__init,
  NULL,NULL,NULL    /* reserved[123] */
};
